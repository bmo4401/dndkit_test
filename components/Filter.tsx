import { SubmittedFormType } from "@/components/FormTable";
...
export function Filter({
  ...
  column: Column<SubmittedFormType, unknown>;
  table: Table<SubmittedFormType>;
}) {
      ...
      {typeof firstValue !== "number" ? (
        <>
          ...
          <DebouncedInput
            type="text"
            value={
              (typeof +(columnFilterValue as number) === "number"
                ? columnFilterValue
